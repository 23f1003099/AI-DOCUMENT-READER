...
const SignUp = () => {
  ...
  const getPasswordStrength = () => {
    ...
    if (passed < 4) return { strength: 'medium', color: 'bg-yellow-500', width: '50%' };
    if (passed < 5) return { strength: 'good', color: 'bg-blue-500', width: '75%' };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start space-x-3">
              <input
                type="checkbox"
                id="terms"
                className="w-4 h-4 text-indigo-600 bg-white/50 border-gray-300 rounded focus:ring-indigo-500 focus:ring-2 mt-1"
                required
              />
              <label htmlFor="terms" className="text-sm text-gray-600 dark:text-gray-400">
                I agree to the{' '}
                <Link to="/terms" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link to="/privacy" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors">
                  Privacy Policy
                </Link>
              </label>
            </div>
